...
<div class="container">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control"  name="fullname"  id="exampleInputEmail1" aria-describedby="emailHelp" value="<?=$user_name?>">
  </div>
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="tel" class="form-control"  name="phone"  id="exampleInputPassword1" value="<?=$tel?>">
  </div>
